...
To build the C/C++ samples, Microsoft Visual Studio 2017 projects (Windows)
and Makefiles (Linux and Mac OS X) have been provided.  These generally
reference the native compilers.
   ...
   The Visual Studio projects reference this for the following files:
      $okFP_SDK/include/okFrontPanel.h
...
Be sure to select the correct FPGA device for your particular board:
   ...
   XEM7010-A50T      => xc7a50tfgg484-1
   XEM7010-A200T     => xc7a200tfbg484-1
   XEM7305           => xc7s50csga324-1
   XEM7310-A75T      => xc7a75tfgg484-1
   XEM7310-A200T     => xc7a200tfbg484-1
   XEM7320-A75T      => xc7a75tfgg484-1
...
Be sure to select the correct FPGA device and settings for your particular board:
  ...
  A. Within Quartus select the correct FPGA device for your board:
     ...
     ZEM5305-A2 ->   5CEFA2U19C8N
     ZEM5310-A4 ->   5CEFA4F23C7N
